...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        // Grain overlay tinted with the new soil (#1A1410 ≈ rgb 26, 20, 16 ≈
        // r 0.10 / g 0.08 / b 0.06) — matches the lighter agrarian-almanac soil.
        grain:
          "url(\"data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='2' stitchTiles='stitch'/%3E%3CfeColorMatrix values='0 0 0 0 0.10 0 0 0 0 0.08 0 0 0 0 0.06 0 0 0 0.10 0'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)'/%3E%3C/svg%3E\")",
      },
    },
  },
  plugins: [],
